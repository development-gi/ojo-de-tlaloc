    ...
    angular.module('ionic.contrib.drawer', ['ionic'])
        ...
        .controller('drawerCtrl', ['$element', '$attrs', '$ionicGesture', '$document', '$ionicPlatform','$rootScope', function($element, $attr, $ionicGesture, $document, $ionicPlatform,$rootScope) {
            ...
            var doEndDrag = function(e) {
              ...
              if(isOpen()){
                try{$rootScope.setMapClickable(false);}catch(e){}
              }else{
                try{$rootScope.setMapClickable(true);}catch(e){}
              }
            ...
            $rootScope.canDragContribDrawer=function(status){
              canDragMenu=status;
            };
        ...
        .directive('drawerClose', ['$ionicViewService', function($ionicViewService) {
            return {
                restrict: 'AC',
                require: '^drawer',
